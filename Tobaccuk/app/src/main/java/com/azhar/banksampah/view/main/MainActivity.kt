...
import com.azhar.banksampah.view.history.RiwayatActivityJual
import com.azhar.banksampah.view.input.InputDataActivityJual
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        ...
        cvInputJual.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, InputDataActivityJual::class.java)
            startActivity(intent)
        }


        cvHistoryJual.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, RiwayatActivityJual::class.java)
            startActivity(intent)
        }
    }
