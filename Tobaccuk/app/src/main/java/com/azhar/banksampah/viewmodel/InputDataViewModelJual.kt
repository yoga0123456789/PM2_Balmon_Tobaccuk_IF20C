...
class InputDataViewModelJual(application: Application) : AndroidViewModel(application) {
    ...
    fun addDataSampah(
        ...
        Completable.fromAction {
            val modelDatabase = ModelDatabaseMasuk()
            ...
            databaseDao?.insertDataMasuk(modelDatabase)
        }
