...
class RiwayatViewModelJual(application: Application) : AndroidViewModel(application) {

    var totalSaldo: LiveData<Int>
    var dataBank: LiveData<List<ModelDatabaseMasuk>>
    var databaseDao: DatabaseDao?

    fun deleteDataById(uid: Int) {
        Completable.fromAction {
            databaseDao?.deleteSingleDataMasuk(uid)
        }
    ...
    init {
        ...
        dataBank = databaseDao!!.getAllMasuk()
        totalSaldo = databaseDao!!.getSaldoMasuk()
    }
